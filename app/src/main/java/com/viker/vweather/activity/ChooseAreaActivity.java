package com.viker.vweather.activity;
 ...
 * 编写用于遍历省市县数据的活动。新建ChooseAreaActivity类继承自Activity类。
 */
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    result = Utility.handleProvincesResponse(vWeatherDB, response);
                } else if ("city".equals(type)) {
                    result = Utility.handleCitiesResponse(vWeatherDB, response,
                            selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = Utility.handleCoutiesResponse(vWeatherDB, response,
                            selectedCity.getId());
                }
                if (result) {
